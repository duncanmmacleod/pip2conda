...
-   Add support for using py-rattler
    ([!62](https://gitlab.com/gwpy/pip2conda/-/merge_requests/62))
-   Add -V/--version command-line option
    ([!64](https://gitlab.com/gwpy/pip2conda/-/merge_requests/64))
-   Drop support for Python 3.10
    ([!65](https://gitlab.com/gwpy/pip2conda/-/merge_requests/65))

[Release details](https://gitlab.com/gwpy/pip2conda/-/releases/0.10.0)
...
-   Add support for Python 3.14
    ([!60](https://gitlab.com/gwpy/pip2conda/-/merge_requests/60))
-   Match more error types for missing channels
    ([!61](https://gitlab.com/gwpy/pip2conda/-/merge_requests/61))

[Release details](https://gitlab.com/gwpy/pip2conda/-/releases/0.9.2)
